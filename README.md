...
Clone of slack with fully functioning chat system.
...
- **Option 2**
  - 👯 Clone this repo to your local machine using `https://github.com/BillyNoyes/slack-clone.git`
...
- 🔃 Create a new pull request using <a href="https://github.com/BillyNoyes/slack-clone/compare/" target="_blank">`https://github.com/BillyNoyes/slack-clone/compare/`</a>.
